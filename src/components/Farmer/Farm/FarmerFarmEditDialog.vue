    ...
    >
      <v-card>
        <v-toolbar class="elevation-3" dense>
          ...
          <v-toolbar-title>แก้ไขข้อมูล</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-layout>
            <v-spacer></v-spacer>
        ...
        <v-card-text>
          <v-flex ma-3>
            ...
            <choice
              class="mt-3"
              to="การขึ้นทะเบียนฟาร์ม"
              v-model="form.farm_issue_status"
              @change="CheckFarmStatus()"
            />
...
export default {
  ...
  data: () => ({
    ...
    farmRegister: {
      id: 120,
      choice: "ขึ้นทะเบียนแล้ว",
      type: "farm_register_status",
      has_text: 0,
      parent_id: null,
      ...
      children: [
        {
          id: 122,
          choice: "ได้การรับรองมาตรฐานฟาร์ม",
          type: "farm_register",
          has_text: 0,
          parent_id: 120,
          created_at: "2016-06-24 04:36:33",
        ...
        {
          id: 123,
          choice: "ไม่ได้รับการรับรองมาตรฐานฟาร์ม",
          type: "farm_register",
          has_text: 0,
          parent_id: 120,
          created_at: "2016-06-24 04:36:33",
        ...
        {
          id: 124,
          choice: "อยู่ระหว่างการขอการรับรอง",
          type: "farm_register",
          has_text: 0,
          parent_id: 120,
          created_at: "2016-06-24 04:36:33",
  ...
  methods: {
    ...
    async syncToQuestion() {
        if(this.form.farm_issue_id){
            this.formSync.farm_register_status = this.farmRegister
        }
        console.log('sync',this.formSync);
    ...
    async load() {
      ...
      this.formSync = await this.$store.dispatch(
        "admin/farmOwners/getFarmOwnerById",
        {
          id: farmOwnerId,
          isAdmin: true
        }
