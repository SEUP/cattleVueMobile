<template>
  <div>
    ...
    <v-dialog v-model="avatarConfirmDialog" persistent scrollable max-width="500px"
  ...
  export default {
    ...
    methods: {
      ...
      save: async function () {
        ...
        let result = await this.$store.dispatch("farmer/uploadAvatar", this.croppa.generateDataUrl('png', 1));
        if (result) {
